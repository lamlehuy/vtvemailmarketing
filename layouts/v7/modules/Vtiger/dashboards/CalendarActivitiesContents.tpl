...
<div class="dashboardWidgetData">
	...
	<div>
		...
		<div>
			...
			<p class='pull-right muted' style='margin-top:5px;padding-right:5px;'><small title="{vtranslate('LBL_FROM')} {Vtiger_Util_Helper::formatDateTimeIntoDayStringVN("$START_DATE $START_TIME")} {vtranslate('LBL_TO')} {Vtiger_Util_Helper::formatDateTimeIntoDayStringVN("$DUE_DATE $DUE_TIME")}">{Vtiger_Util_Helper::formatDateDiffInStrings("$START_DATE $START_TIME")}</small></p>

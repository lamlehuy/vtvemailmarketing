<?php /* Smarty version Smarty-3.1.7, created on 2017-06-27 18:05:32
         compiled from "E:\PhpCode\LeGia\demo.quanlykhachhang.info\includes\runtime/../../layouts/v7\modules\Vtiger\dashboards\CalendarActivitiesContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1391159520d32dc39b9-05730701%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a09dfe613aeebf9acb2126057dee4c782e750ae2' => 
    array (
      0 => 'E:\\PhpCode\\LeGia\\demo.quanlykhachhang.info\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\dashboards\\CalendarActivitiesContents.tpl',
      1 => 1498561237,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1391159520d32dc39b9-05730701',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_59520d32e375f',
  'variables' => 
  array (
    'ACTIVITIES' => 0,
    'ACTIVITY' => 0,
...
<?php if ($_valid && !is_callable('content_59520d32e375f')) {function content_59520d32e375f($_smarty_tpl) {?>
...
<?php }?>
			...
			<p class='pull-right muted' style='margin-top:5px;padding-right:5px;'><small title="<?php echo vtranslate('LBL_FROM');?>
 <?php echo Vtiger_Util_Helper::formatDateTimeIntoDayStringVN(($_smarty_tpl->tpl_vars['START_DATE']->value)." ".($_smarty_tpl->tpl_vars['START_TIME']->value));?>
 <?php echo vtranslate('LBL_TO');?>
 <?php echo Vtiger_Util_Helper::formatDateTimeIntoDayStringVN(($_smarty_tpl->tpl_vars['DUE_DATE']->value)." ".($_smarty_tpl->tpl_vars['DUE_TIME']->value));?>

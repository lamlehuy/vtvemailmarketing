...
$languageStrings = array(
	'LBL_ADD_RECORD' => 'Thêm Picklist phụ thuộc',
    'PickListDependency' => 'PickList phụ thuộc',
	...
	'LBL_CONFIGURE_DEPENDENCY_HELP_2' => "Nếu bạn muốn thay đổi giá trị của trường cha thì hãy click vào nut 'Chọn giá trị nguồn' bên tay phải",
	...
	'LBL_SELECT_SOURCE_PICKLIST_VALUES' => 'Chọn giá trị picklist nguồn',
    ...
    'LBL_CYCLIC_DEPENDENCY_ERROR' => 'Điều này có thể kết thúc trong chu kỳ dự phòng như %s lĩnh vực đã được cấu hình cho %s lĩnh vực',
);

$jsLanguageStrings = array(
	'JS_LBL_ARE_YOU_SURE_YOU_WANT_TO_DELETE' => 'Bạn có muốn xóa Picklist phụ thuộc này không?',
	'JS_DEPENDENCY_DELETED_SUEESSFULLY' => 'Đã xóa giá trị phụ thuộc',
	'JS_PICKLIST_DEPENDENCY_SAVED' => 'Đã lưu Picklist phụ thuộc',
